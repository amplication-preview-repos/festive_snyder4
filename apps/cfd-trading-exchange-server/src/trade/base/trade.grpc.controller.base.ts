...
export class TradeGrpcControllerBase {
  ...
  @GrpcMethod("TradeService", "trades")
  ...
  @swagger.ApiOkResponse({ type: Trade })
  @swagger.ApiNotFoundResponse({ type: errors.NotFoundException })
  @GrpcMethod("TradeService", "updateTrade")
  async updateTrade(
    @common.Param() params: TradeWhereUniqueInput,
  ...
  @swagger.ApiOkResponse({ type: Trade })
  @swagger.ApiNotFoundResponse({ type: errors.NotFoundException })
  @GrpcMethod("TradeService", "deleteTrade")
  async deleteTrade(
    @common.Param() params: TradeWhereUniqueInput
  ): Promise<Trade | null> {
    try {
